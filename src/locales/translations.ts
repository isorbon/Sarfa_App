...
const translationsMap: Record<LanguageCode, Translation> = {
    ...
    'hi': { // Hindi
        ...
        common: {
            ...enUS.common,
            appTitle: 'Sarfa - खर्च ट्रैकर',
            dashboard: 'डैशबोर्ड',
            allExpenses: 'सभी खर्चे',
            billsSubscription: 'बिल और सदस्यता',
            investment: 'निवेश',
            cards: 'कार्ड',
            goals: 'लक्ष्य',
            analytics: 'विश्लेषण',
            ...
            expensesList: 'खर्चों की सूची',
            totalExpenses: 'कुल खर्चे',
            count: 'गणना',
            general: 'सामान्य',
            tools: 'उपकरण',
            trackTagline: 'अपने सभी खर्चों को ट्रैक करें',
        ...
        expenses: {
            ...
            paymentModeCash: 'नकद',
            paymentModeCard: 'क्रेडिट कार्ड',
            paymentModeBank: 'बैंक ट्रांसफर',
            paymentModeWallet: 'डिजिटल वॉलेट',
            paymentModeOther: 'अन्य',
            noExpenses: 'कोई खर्चा नहीं मिला',
            deleteTitle: 'खर्चा हटाएं',
            deleteMessage: 'क्या आप वाकई इस खर्चे को हटाना चाहते हैं?',
            icon: 'आइकन',
            mode: 'मोड',
        },
        cards: {
            ...
            addFirstCard: 'खर्चों को ट्रैक करने के लिए अपना पहला कार्ड जोड़ें',
            deleteTitle: 'कार्ड हटाएं',
            deleteMessage: 'क्या आप वाकई इस कार्ड को हटाना चाहते हैं? यह क्रिया पूर्ववत नहीं की जा सकती।',
            selectCard: 'एक कार्ड चुनें',
            noCardsAvailable: 'कोई कार्ड उपलब्ध नहीं है। कृपया पहले कार्ड पेज से एक कार्ड जोड़ें।',
            namePlaceholder: 'उदा., Visa Gold',
            bankPlaceholder: 'उदा., HDFC Bank',
            expensesByCard: 'कार्ड के अनुसार खर्चे',
        },
        goals: {
            goalName: 'लक्ष्य का नाम',
            targetAmount: 'लक्षित राशि',
            currentAmount: 'बचत राशि',
            deadline: 'समय सीमा',
            noGoals: 'अभी तक कोई लक्ष्य नहीं',
            addFirstGoal: 'अपना पहला वित्तीय लक्ष्य निर्धारित करें',
            subtitleWithGoals: 'अपने वित्तीय लक्ष्य निर्धारित करें और उन्हें प्राप्त करें',
            deleteTitle: 'लक्ष्य हटाएं',
            deleteMessage: 'क्या आप वाकई इस लक्ष्य को हटाना चाहते हैं?',
            reached: 'लक्ष्य प्राप्त!',
            left: 'शेष',
            daysLeft: 'दिन शेष',
            namePlaceholder: 'उदा., नई कार',
            goalImage: 'लक्ष्य छवि',
            uploadImage: 'अपलोड करने के लिए क्लिक करें या ड्रैग और ड्रॉप करें',
        },
        bills: {
            totalMonthly: 'कुल मासिक बिल',
            upcoming: 'आगामी बिल',
            overdue: 'बकाया बिल',
            total: 'कुल बिल',
            trendMonthly: 'पिछले महीने से +2.5%',
            trendUpcoming: 'अगले 7 दिनों में देय',
            trendOverdue: 'ध्यान देने की आवश्यकता है',
            trendTotal: 'सभी सदस्यताएं',
            allTime: 'सभी समय',
            moreFilters: 'अधिक फ़िल्टर',
            statusOverdue: 'बकाया',
            statusDueSoon: 'जल्द देय',
            statusActive: 'सक्रिय',
            addFirstBill: 'शुरू करने के लिए अपना पहला बिल या सदस्यता जोड़ें',
        },
        dashboard: {
            subtitle: 'अपने क्रेडिट और डेबिट खर्चों का प्रबंधन करें',
        ...
        modals: {
            ...
            editExpenseTitle: 'खर्चा संपादित करें',
            addCardTitle: 'नया कार्ड जोड़ें',
            editCardTitle: 'कार्ड संपादित करें',
            addGoalTitle: 'नया लक्ष्य जोड़ें',
            editGoalTitle: 'लक्ष्य संपादित करें',
            saving: 'सहेजा जा रहा है...',
        },
        settings: {
            subtitle: 'अपने खाते की प्राथमिकताएं और सेटिंग्स प्रबंधित करें',
            avatar: 'अवतार',
            upload: 'अपलोड करें',
            avatarUrlPlaceholder: 'या अवतार URL दर्ज करें',
            avatarHelp: 'अपलोड करने या URL पेस्ट करने के लिए छवि पर क्लिक करें',
            fullName: 'पूरा नाम',
            currency: 'मुद्रा',
            currencyHelp: 'विनिमय दरें Wise से प्राप्त की जाती हैं।',
            changePassword: 'पासवर्ड बदलें',
            newPassword: 'नया पासवर्ड',
            repeatPassword: 'नया पासवर्ड दोहराएं',
            ...
            avatarUploadError: 'छवि अपलोड करने में विफल',
            avatarUrlSaved: 'अवतार URL सहेजा गया!',
            avatarUrlError: 'अवतार URL सहेजने में विफल',
            nameSaved: 'नाम सहेजा गया!',
            nameError: 'नाम सहेजने में विफल',
            currencyUpdated: 'मुद्रा अपडेट की गई!',
            currencyError: 'मुद्रा अपडेट करने में विफल',
        },
        filters: {
            all: 'सभी',
            foodGrocery: 'खाद्य और किराना',
            investment: 'निवेश',
            shopping: 'खरीदारी',
            travelling: 'यात्रा',
            miscellaneous: 'विविध',
            bills: 'बिल और सदस्यता',
            recent: 'हाल ही का',
